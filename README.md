...
![VirtualBox](screenshots/01_virtualbox_installed.png)

![Ubuntu Wazuh Server](screenshots/03_ubuntu_server_running.png)

![Wazuh Dashboard](screenshots/08_wazuh_dashboard_login.png)

### Endpoint & Network Validation

![Windows Agent](screenshots/09_agent_installed_windows.png)

![Network Connectivity](screenshots/06_network_connectivity.png)

### Brute Force Detection

![Hydra RDP Simulation](screenshots/11_bruteforce_attack_running.png)

![Wazuh Brute Force Alert](screenshots/13_bruteforce_alert_detail.jpg)

### Network Reconnaissance

![Nmap Scan](screenshots/14_nmap_scan_running.png)

![Firewall Evidence](screenshots/15_portscan_firewall_drops.png)

### PowerShell Detection

![PowerShell Activity](screenshots/16_suspicious_commands_windows.png)

![Wazuh PowerShell Alert](screenshots/17_suspicious_process_alert.jpg)

### Data Transfer Simulation

![Simulated Exfiltration](screenshots/20_exfiltration_kali_received.png)
